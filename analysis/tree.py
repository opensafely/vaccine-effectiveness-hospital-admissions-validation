...
features = [
    "ae_attendance_hosp_discharge",
    "risk_group",
    "ae_attendance_covid_status",
    "ae_attendance_respiratory_status",
    "positive_covid_test_before_ae_attendance",
    "positive_covid_test_month_before_ae_attendance",
    "positive_covid_test_week_before_ae_attendance",
    "covid_primary_care_before_ae_attendance",
    "suspected_covid_primary_care_before_ae_attendance",
]
